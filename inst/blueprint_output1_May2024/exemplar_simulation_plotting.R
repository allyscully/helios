...
#+++ Epidemic +++#
epidemic_baseline_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/exemplar_baseline_output_raw_3331.rds"
)
epidemic_random_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/exemplar_uvc_random_output_raw_33331.rds"
)
epidemic_targeted_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/exemplar_uvc_targeted_output_raw_33331.rds"
)

#+++ Endemic +++#
endemic_baseline_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/endemic_baseline_2_week_immunity_10_years.rds"
)
endemic_random_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/endemic_random_uvc_2_week_immunity_10_years.rds"
)
endemic_targeted_raw <- readRDS(
  "/Users/trb216/OneDrive - Imperial College London/Desktop/helios/data/blueprint_demo_May_raw_outputs/endemic_targeted_uvc_2_week_immunity_10_years.rds"
)
...
#+++ Combined +++#
exemplar_long <- bind_rows(
  epidemic_baseline_long,
  epidemic_random_long,
  epidemic_targeted_long,
  endemic_baseline_long,
  endemic_random_long,
  endemic_targeted_long
)
...
epidemic_baseline_raw %>%
  ...
  mutate(
    Susceptible = Susceptible / Total_count,
  ...
  pivot_longer(
    cols = c(Susceptible, Exposed, Infected, Recovered),
    names_to = "State",
    values_to = "Proportion"
  ) %>%
  mutate(
...
exemplar_long %>%
  ...
  theme(
    strip.background = element_rect(fill = "#03113E"),
