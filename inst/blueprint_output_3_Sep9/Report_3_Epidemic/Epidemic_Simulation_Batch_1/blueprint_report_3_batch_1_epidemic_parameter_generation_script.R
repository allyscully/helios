...
setwd(
  "./inst/blueprint_output_3_Sep9/Report_3_Epidemic/Epidemic_Simulation_Batch_1/"
)
...
saveRDS(
  parameter_lists,
  file = "./epidemic_simulations_parameter_lists_batch_1.rds"
)
...
for (i in 1:length(lower_bounds)) {
  ...
  assign(
    x = paste0(
      "epidemic_simulation_parameter_list_",
      lower_bounds[i],
      "_",
      upper_bounds[i]
    ),
  ...
  saveRDS(
    ...
    file = paste0(
      "./epidemic_batch_1_inputs/epidemic_simulation_parameter_list_",
      i,
      "_",
      lower_bounds[i],
      "_",
