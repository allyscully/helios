...
for (i in 15:15) {
  ...
  saveRDS(
    object = batch_number,
    file = "./Report_3_Epidemic/Epidemic_Simulation_Batch_1/batch_number.rds"
  )
    ...
    value = hipercow::task_create_explicit(
      ...
      expr = quote({
        ...
        batch_number <- readRDS(
          "./Report_3_Epidemic/Epidemic_Simulation_Batch_1/batch_number.rds"
        )
        ...
        saveRDS(
          ...
          file = paste0(
            "./Report_3_Epidemic/Epidemic_Simulation_Batch_1/epidemic_batch_1_outputs/scenario_output_batch_1_",
            batch_number,
            ".rds"
          )
        )
...
saveRDS(
  object = job_IDS,
  file = "./Report_3_Epidemic/Epidemic_Simulation_Batch_1/batch_1_rerun_job_ids.rds"
)
job_IDS <- readRDS(
  "./Report_3_Epidemic/Epidemic_Simulation_Batch_1/batch_1_rerun_job_ids.rds"
)
