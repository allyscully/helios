...
parameters_individuals <- set_uvc(
...
switches_individuals <- generate_far_uvc_switches(
  parameters_list = parameters_individuals,
...
size_covered_individuals <- list(
  "workplace" = sum(
    switches_individuals$setting_sizes$workplace *
      switches_individuals$uvc_workplace
  ),
  "school" = sum(
    switches_individuals$setting_sizes$school * switches_individuals$uvc_school
  ),
  # "household" = sum(switches_individuals$setting_sizes$household * switches_individuals$uvc_household),
  "leisure" = sum(
    switches_individuals$setting_sizes$leisure *
      switches_individuals$uvc_leisure
  )
)
...
(total_size_individuals * switches_individuals$far_uvc_joint_coverage) /
  sum(unlist(size_covered_individuals))

# Plot the UVC switches against the specific-riskinesses of each setting type:
plot(
  switches_individuals$uvc_school,
  parameters_individuals$school_specific_riskiness,
  cex = 0.01
)
plot(
  switches_individuals$uvc_workplace,
  parameters_individuals$workplace_specific_riskiness,
  cex = 0.01
)
plot(
  switches_individuals$uvc_leisure,
  parameters_individuals$leisure_specific_riskiness,
  cex = 0.01
)
...
parameters_square_footage <- set_uvc(
  parameters_list = parameters,
  setting = "joint",
  coverage = 0.5,
  coverage_target = "square_footage",
...
switches_square_footage <- generate_far_uvc_switches(
  parameters_list = parameters_square_footage,
  variables_list = variables_list
)
...
size_covered_square_footage <- list(
  "workplace" = sum(
    switches_square_footage$setting_sizes$workplace *
      switches_square_footage$uvc_workplace *
      switches_square_footage$size_per_individual_workplace
  ),
  "school" = sum(
    switches_square_footage$setting_sizes$school *
      switches_square_footage$uvc_school *
      switches_square_footage$size_per_individual_school
  ),
  ...
  "leisure" = sum(
    switches_square_footage$setting_sizes$leisure *
      switches_square_footage$uvc_leisure *
      switches_square_footage$size_per_individual_leisure
  )
)


total_size_square_footage <- sum(
  switches_square_footage$setting_sizes$workplace
) *
  switches_square_footage$size_per_individual_workplace +
  sum(switches_square_footage$setting_sizes$school) *
    switches_square_footage$size_per_individual_school +
  # sum(switches_square_footage$setting_sizes$household) *  switches_square_footage$size_per_individual_household  +
  sum(switches_square_footage$setting_sizes$leisure) *
    switches_square_footage$size_per_individual_leisure
(total_size_square_footage * switches_square_footage$far_uvc_joint_coverage) /
  sum(unlist(size_covered_square_footage)) # checking coverages match up
plot(
  switches_square_footage$uvc_school,
  parameters_square_footage$school_specific_riskiness,
  cex = 0.01
)
plot(
  switches_square_footage$uvc_workplace,
  parameters_square_footage$workplace_specific_riskiness,
  cex = 0.01
)
plot(
  switches_square_footage$uvc_leisure,
  parameters_square_footage$leisure_specific_riskiness,
  cex = 0.01
)
...
#
parameters_individuals_riskiness <- set_uvc(
  parameters_list = parameters,
  setting = "joint",
  coverage = 0.5,
  coverage_target = "individuals",
...
switches_individuals_riskiness <- generate_far_uvc_switches(
  parameters_list = parameters_individuals_riskiness,
  variables_list = variables_list
)
size_covered_individuals_riskiness <- list(
  "workplace" = sum(
    switches_individuals_riskiness$setting_sizes$workplace *
      switches_individuals_riskiness$uvc_workplace
  ),
  "school" = sum(
    switches_individuals_riskiness$setting_sizes$school *
      switches_individuals_riskiness$uvc_school
  ),
  # "household" = sum(switches_individuals_riskiness$setting_sizes$household * switches_individuals_riskiness$uvc_household),
  "leisure" = sum(
    switches_individuals_riskiness$setting_sizes$leisure *
      switches_individuals_riskiness$uvc_leisure
  )
)
total_size_individuals_riskiness <- sum(
  switches_individuals_riskiness$setting_sizes$workplace
) +
...
(total_size_individuals_riskiness *
  switches_individuals_riskiness$far_uvc_joint_coverage) /
  sum(unlist(size_covered_individuals_riskiness)) # checking coverages match up
plot(
  switches_individuals_riskiness$uvc_school,
  parameters_individuals_riskiness$school_specific_riskiness,
  cex = 0.01
)
plot(
  switches_individuals_riskiness$uvc_workplace,
  parameters_individuals_riskiness$workplace_specific_riskiness,
  cex = 0.01
)
plot(
  switches_individuals_riskiness$uvc_leisure,
  parameters_individuals_riskiness$leisure_specific_riskiness,
  cex = 0.01
)
...
#++++++++++  coverage_type = "targeted_riskiness" +++++++++++++#
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
parameters_square_footage_riskiness <- set_uvc(
  parameters_list = parameters,
  setting = "joint",
  coverage = 0.5,
  coverage_target = "square_footage",
...
switches_square_footage_riskiness <- generate_far_uvc_switches(
  parameters_list = parameters_square_footage_riskiness,
  variables_list = variables_list
)
size_covered_square_footage_riskiness <- list(
  "workplace" = sum(
    switches_square_footage_riskiness$setting_sizes$workplace *
      switches_square_footage_riskiness$uvc_workplace *
      switches_square_footage_riskiness$size_per_individual_workplace
  ),
  "school" = sum(
    switches_square_footage_riskiness$setting_sizes$school *
      switches_square_footage_riskiness$uvc_school *
      switches_square_footage_riskiness$size_per_individual_school
  ),
  ...
  "leisure" = sum(
    switches_square_footage_riskiness$setting_sizes$leisure *
      switches_square_footage_riskiness$uvc_leisure *
      switches_square_footage_riskiness$size_per_individual_leisure
  )
)
total_size_square_footage_riskiness <- sum(
  switches_square_footage_riskiness$setting_sizes$workplace
) *
  switches_square_footage_riskiness$size_per_individual_workplace +
  sum(switches_square_footage_riskiness$setting_sizes$school) *
    switches_square_footage_riskiness$size_per_individual_school +
  ...
  sum(switches_square_footage_riskiness$setting_sizes$leisure) *
    switches_square_footage_riskiness$size_per_individual_leisure
(total_size_square_footage_riskiness *
  switches_square_footage_riskiness$far_uvc_joint_coverage) /
  sum(unlist(size_covered_square_footage_riskiness)) # checking coverages match up
plot(
  switches_square_footage_riskiness$uvc_school,
  parameters_square_footage_riskiness$school_specific_riskiness,
  cex = 0.01
)
plot(
  switches_square_footage_riskiness$uvc_workplace,
  parameters_square_footage_riskiness$workplace_specific_riskiness,
  cex = 0.01
)
plot(
  switches_square_footage_riskiness$uvc_leisure,
  parameters_square_footage_riskiness$leisure_specific_riskiness,
  cex = 0.01
)
...
model_run_individual_riskiness <- run_simulation(
  parameters_individuals_riskiness
)
model_run_square_footage_riskiness <- run_simulation(
  parameters_square_footage_riskiness
)

### needs to be completed
plot(
  model_run_individual$timestep,
  model_run_individual$E_new,
  type = "l",
  col = "black"
)
lines(
  model_run_individual_riskiness$timestep,
  model_run_individual_riskiness$E_new,
  type = "l",
  col = "darkorchid"
)
lines(
  model_run_square_footage$timestep,
  model_run_square_footage$E_new,
  type = "l",
  col = "blue"
)
lines(
  model_run_individual_riskiness$timestep,
  model_run_square_footage_riskiness$E_new,
  type = "l",
  col = "orange"
)
