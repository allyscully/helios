...
Currently, we depend on a particular branch of the `individual` package, which you can install using:
...
* **July 2024**: [Update to "assessing far UVC interventions with an individual based infectious disease model"](https://mrc-ide.github.io/helios/articles/blueprint-july.html) describes two updates to our initial model
* **September 2025**: [The Impact of Far UVC Interventions on the Burden of a Respiratory Virus](https://mrc-ide.github.io/helios/articles/blueprint-final-report.html)
